...
public class Frmbarang_1 extends javax.swing.JDialog {
    ...
    public Frmbarang_1(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initUI();
    ...
    private void SelectKategori(){
        try {
            ...
            Logger.getLogger(Frmbarang_1.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
...
//                Logger.getLogger(FrmtransaksiKeluar.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frmbarang_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Frmbarang_1 dialog = new Frmbarang_1(new javax.swing.JFrame(), true);
